import { Accordion, Button, Flex, Stack, Text, Textarea } from '@mantine/core';
...
export const FilteredArticleBlock = memo(({ article }: ArticleBlockProps) => {
  ...
  return (
    <Accordion.Item value={JSON.stringify({ id, image_url })}>
      <Accordion.Control style={{ textAlign: 'right' }}>
...
export default FilteredArticleBlock;
